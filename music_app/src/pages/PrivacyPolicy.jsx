...
function PrivacyPolicy(){
    return(
        ...
        recorded by Starbies and how we use it. If you have additional questions or require 
        ...
        to our website with regards to the information that they shared and/or collect in Rootine.
        This policy is not applicable to any information collected offline or via channels other than 
        this website. Consent By using our website, you hereby consent to our Privacy Policy and agree 
        to its terms.</p>
        <br/>
        ...
        address, the contents of the message, and any other information you may choose to provide. When you 
        register for an Account, we may ask for your contact information, including items such as name, and 
        email address. We use the information we collect in various ways, including to:</p>
        <ul>
            ...
            the website, and for marketing and promotional purposes</li>
            <li>Send you emails</li>
            <li>Find and prevent fraud</li>
            <li>Starbies follows a standard procedure of using log files. These files log visitors 
            ...
            tracking users' movement on the website, and gathering demographic information.</li>
        </ul>
        <br/>
        <p>Like any other website, Starbies uses ‘cookies'. These cookies are used to store information 
        ...
        <br/>
        <p>Rootine's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you 
        ...
        complete list of these Privacy Policies and their links here: Privacy Policy Links. You can choose to 
        disable cookies through your individual browser options. To know more detailed information about cookie 
        ...
        <ul>
            ...
            you believe is inaccurate. You also have the right to request that we complete the information you 
            ...
            of these rights, please contact us.</li>
        </ul>
        <br/>
        ...
        online activity. Rootine does not knowingly collect any Personal Identifiable Information from 
